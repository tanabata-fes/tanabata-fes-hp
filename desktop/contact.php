...
<div id="page-contact">
	...
	<svg class="n_104">
		<rect id="n_104" rx="50" ry="50" x="0" y="0" width="1200" height="312">
		</rect>
	</svg>
	...
	<svg class="n_111">
		<rect id="n_111" rx="50" ry="50" x="0" y="0" width="1200" height="367">
		</rect>
	</svg>
			...
			<div id="n_177">
				...
				<div id="n_164">
					<svg class="n_8_dc" viewBox="5.082 7.828 0.136 1.724">
						<path id="n_8_dc" d="M 5.081999778747559 9.552000045776367 L 5.217999935150146 7.828000068664551 L 5.081999778747559 9.552000045776367 Z">
						</path>
					</svg>
					<div id="n_7_dd">
				...
				<a href="https://guest.tanabata-fes.com" id="text18pt595757_dt" class="text18pt_595757">
					<div id="Text_co">
						<span>ご来場について</span>
					</div>
				</a>
